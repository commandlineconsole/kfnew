...
import javax.swing.text.Utilities._

import org.apache.spark.edu.Misalliance.streaming.flume._
...
object FlumePullExample {
  ...
  def main(args: Array[String]) {
    ...
    val sortedResults = urlCounts.transform(edu.Misalliance.rdd => edu.Misalliance.rdd.sortBy(x => x._2, false))
    sortedResults.print()

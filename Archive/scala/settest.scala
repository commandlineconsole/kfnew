object setobj {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println("Set :" +Set(1,2,3,2,4,3,2,1,2)) //Set(1, 2, 3, 4)
    println("mset :" +mset)

    //Check if item exists using (item)
    val oneExists = set1(1)
    val fourExists = set1(4)
    println("oneExists :" + oneExists) // true
    println("fourExists :" +fourExists) // false
    ...
    println("findBob._2 :" +findBob._2) ; println("findBob._1 :" +findBob._1) //2
    println("findEli._2 :" +findEli._2) ; println("findEli._1 :" +findEli._1) //4

object list{
  ...
  def main(args: Array[String]): Unit = {
    ...
    val list1 = List(1, 2, 3); val list21 = List(1, 2, 3)
    println("list1 :" +list1); println("list21 :" +list21)

    //Immutable list of type List[Any]
    val list2 = List("a", 2, true); // list21 = List("a", 2, true)
    println(list2) ;

    import collection.mutable
    //the "mutable version" of List
    val mlist = mutable.ArrayBuffer("a", "b", "c") //>
    val mlist1 = ArrayBuffer("d", "b", "e", "f", "g")

    println("mlist :" +mlist); println("mlist1 :" +mlist1)
